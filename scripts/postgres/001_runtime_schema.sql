...
ALTER TABLE models
    ...
    ALTER COLUMN price_multiplier SET DEFAULT 1;
    ...
    IF EXISTS (
        ...
        WITH target_pricing AS (
            SELECT
                ...
                MIN(COALESCE(m.price_multiplier, 1)) AS price_multiplier
        ...
        WHERE em.name = tp.external_model_name
          ...
          AND COALESCE(em.price_multiplier, 1) = 1;
    END IF;
END $$;
...
BEGIN
    IF NOT EXISTS (
        ...
        EXECUTE '
            ALTER TABLE models
            ADD COLUMN price_multiplier NUMERIC(10, 4) NOT NULL DEFAULT 1
        ';
    END IF;
END $$;
